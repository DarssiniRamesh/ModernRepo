package com.example.java21backend;
...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for java21backend")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to java21backend";
    }
    ...
    public String info() {
        return "Spring Boot Application: java21backend";
    }
} 